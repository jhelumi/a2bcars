          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg border border-blue-200 p-6">
              <section>
                ...
                <ul className="list-disc  list-inside ml-4 mb-4 text-left">
                  ...
                  <li>
                    Clear communication before, during, and after your journey
                  </li>
                  <li>A calm and comfortable travel experience</li>
                  <li>A calm and comfortable travel experience</li>
                </ul>
                <p>
                  All our vehicles are fully licensed by Buckinghamshire
                  Council, and every driver is DBS-checked, insured, medically
                  cleared, and trained to a high standard.
                </p>
              </section>
            </div>
            <div className="bg-white rounded-lg border border-blue-200 p-6">
              <section>
                ...
                <p>
                  Most of our customers come back again and again — some for
                  more than a decade — because they know we do things properly.
                  We respect your time, your privacy, and the trust you place in
                  us. Whether you&apos;re a family travelling to the airport or
                  a business sending staff across the country, we make sure the
                  journey is handled professionally and with care.
                </p>
              </section>
            </div>
            <div className="bg-white rounded-lg border border-blue-200 p-6">
            ...
            <div className="bg-white rounded-lg border border-blue-200 p-6">
              <section>
                ...
                <p>
                  We proudly cover Buckinghamshire, South Oxfordshire &
                  Hertfordshire, with a strong local presence in Aylesbury,
                  Thame, Haddenham, Long Crendon, Princes Risborough, Wendover,
                  and surrounding areas.
                  <br />
                  Wherever you&apos;re going — we aim to make your journey as
            ...
            <div className="bg-white rounded-lg border border-blue-200 p-6">
              <section>
                ...
                <p>
                  We look forward to providing you with a smooth, calm, and
