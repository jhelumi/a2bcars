      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col items-center gap-6 text-center  text-brand-gray sm:items-start sm:text-left">
          ...
          <p className="text-lg leading-8 dark:text-zinc-400">
            When you need to travel between major cities, you want a service
            that’s comfortable, reliable, and handled with care. Our
            city-to-city travel service is designed to give you a calm and
            smooth journey without the stress of trains, parking, or tight
            schedules. We offer direct, door-to-door travel at a pace that suits
            you.
            <br />
            Whether it’s for business, a family visit, a special event, or
            simply avoiding the hassle of public transport, A2B Cars makes
            long-range city travel easy and enjoyable.
          </p>
          <h2 className="text-xl font-semibold leading-10 tracking-tight text-brand-blue dark:text-zinc-50">
            Why Choose City-to-City Travel With Us
          </h2>
          ...
          <p>
            We’ve been operational since 1999, and many of our customers choose
            us for regular inter-city travel because they know we do things
            properly and make their journey feel effortless.
          </p>
          ...
          <p>
            If your route isn&apos;t listed, just ask — we can usually provide
            it.
          </p>
          ...
          <h2 className="text-xl font-semibold leading-10 tracking-tight text-brand-blue dark:text-zinc-50">
            Corporate City-to-City Travel
          </h2>
          <p>
            Many of our corporate clients rely on us for regular travel between
            cities for:
          </p>
          <ul className="list-disc  list-inside ml-4 text-left">
            <li>Meetings</li>
          ...
          <p>
            We offer smooth, discreet, and reliable travel with simple invoicing
