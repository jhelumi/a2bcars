      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-left">
        <div className="flex flex-col items-center gap-6 text-center  text-brand-gray sm:items-start sm:text-left">
          ...
          <p className="text-lg leading-8 dark:text-zinc-400">
            ...
            you need a service that’s comfortable, reliable, and handled with
            care. At A2B Cars, we specialise in long-distance travel across the
            UK, giving you a calm and enjoyable experience from the moment you
            step into the vehicle until you reach your destination.
            <br />
            Whether you're travelling for business, visiting family, heading to
            an event, or starting a holiday, we make sure the journey feels
            relaxed, safe, and well-organised.
          </p>
          ...
          <p>
            We’ve been operational since 1999, and we’ve helped thousands of
            customers travel smoothly across the UK. Our long-distance service
            is ideal for individuals, families, and corporate clients who want
            peace of mind and a smooth, comfortable journey.
          </p>
          ...
          <p>
            If your destination isn’t listed here, simply ask — we can usually
            help.
          </p>
          ...
          <p>
            If you’re travelling for business or sending staff to meetings,
            conferences, or regional offices, we provide a calm, reliable
            service with:
          </p>
          <ul className="list-disc  list-inside ml-4 text-left">
