    ...
    <div className="min-h-screen  bg-zinc-50 font-sans dark:bg-black">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-left">
        ...
        <div className="flex flex-col items-center gap-6 text-center  text-brand-gray sm:items-start sm:text-left">
          ...
          When your journey takes you further than the usual day-to-day trips, you need a service that’s comfortable, reliable, and handled with care. At A2B Cars, we specialise in long-distance travel across the UK, giving you a calm and enjoyable experience from the moment you step into the vehicle until you reach your destination.

          <br/>Whether you're travelling for business, visiting family, heading to an event, or starting a holiday, we make sure the journey feels relaxed, safe, and well-organised.
        ...
        <h2 className="text-xl font-semibold leading-10 tracking-tight text-brand-blue dark:text-zinc-50">Why Choose Long-Distance Travel With Us</h2>
            ...
            <ul className="list-disc  list-inside ml-4 text-left" >
              ...
              <li>Stress-Free Travel Without Parking, Trains, or Connections</li>
              <li>Safe and Steady Driving for Long Motorway Routes</li>
              <li>Flexible Scheduling to Suit Your Plans</li>              
              </ul>
           
            <p>We’ve been operational since 1999, and we’ve helped thousands of customers travel smoothly across the UK. Our long-distance service is ideal for individuals, families, and corporate clients who want peace of mind and a smooth, comfortable journey.</p>
        ...
        <p>If your destination isn’t listed here, simply ask — we can usually help.</p>
        ...
        <p>All vehicles are licensed by Buckinghamshire Council, kept clean, and maintained to a high standard for comfort and safety.</p>
