          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg border border-blue-200 p-6">
              <section>
                ...
                <p>
                  Many businesses rely on us for regular airport journeys
                  because we prioritise punctuality and comfort.
                </p>
              </section>
            </div>
            <div className="bg-white rounded-lg border border-blue-200 p-6">
            ...
            <div className="bg-white rounded-lg border border-blue-200 p-6">
              <section>
                ...
                <p>
                  Streamline your company&apos;s transport needs with our
                  corporate account benefits:
                </p>
                <ul className="list-disc  list-inside ml-4 mb-4 text-left">
            ...
            <div className="bg-white rounded-lg border border-blue-200 p-6">
              <section>
                ...
                <p>
                  We work with companies of all sizes — from small teams to
                  large corporate clients — and many of them have stayed with us
                  for years because they trust the way we work.
                  <br />
                  Whether it’s transporting staff, meeting visitors, or ensuring
                  your team reaches the airport on time, we provide a reliable
                  service that reflects positively on your business.
                </p>
              </section>
            </div>
          </div>
