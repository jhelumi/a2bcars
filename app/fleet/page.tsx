      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col items-center gap-6 text-center  text-brand-gray sm:items-start sm:text-left">
          ...
          <p className="text-lg leading-8 dark:text-zinc-400">
            At A2B Cars, we use a selected range of high-quality executive
            vehicles to ensure every journey feels smooth, calm, and
            comfortable. All our vehicles are licensed by Buckinghamshire
            Council and kept to a clean, professional standard.
            <br />
            Whether you&apos;re travelling to the airport, heading to a business
            meeting, or planning a long-distance journey, our fleet is designed
            to give you a reliable and peaceful travel experience.
          </p>
          <h2 className="text-xl font-semibold leading-10 tracking-tight text-brand-blue dark:text-zinc-50">
            Mercedes S-Class — Executive Luxury
          </h2>
          <p>
            The Mercedes S-Class is ideal for customers who want the highest
            level of comfort, space, and refinement.
          </p>
          ...
          <span className="text-md font-semibold mb-0 p-0">
            Luggage Capacity:
          </span>
          ...
          <h2 className="text-xl font-semibold leading-10 tracking-tight text-brand-blue dark:text-zinc-50">
            Mercedes E-Class — Executive Comfort
          </h2>
          <p>
            Our Mercedes E-Class offers a smart, professional, and comfortable
            experience for everyday executive travel.
          </p>
          <ul className="list-disc  list-inside ml-4 text-left">
            <li>Clean, Modern Interior</li>
            <li>Comfortable and Spacious Seating</li>
            <li>
              Ideal for Airport Transfers, Business Trips, and Long-Distance
              Travel
            </li>
          ...
          <h2 className="text-xl font-semibold leading-10 tracking-tight text-brand-blue dark:text-zinc-50">
            Mercedes V-Class — Group & Premium Travel
          </h2>
          <p>
            The Mercedes V-Class is the perfect choice for families, small
            groups, or corporate teams who need more space with executive
            comfort.
          </p>
          ...
          <ul className="list-disc  list-inside ml-4 text-left">
            ...
            <li>
              Ideal for Events, Long-Distance Journeys, and Airport Transfers
            </li>
          </ul>
          ...
          <h2 className="text-xl font-semibold leading-10 tracking-tight text-brand-blue dark:text-zinc-50">
            Mercedes Vito 8-Seater — Practical Group Travel
          </h2>
          <p>
            For larger groups, our Mercedes Vito provides a comfortable and
            practical option for up to 8 passengers.
          </p>
          ...
          <ul className="list-disc  list-inside ml-4 text-left">
            ...
            <li>
              Great for Events, Family Travel, Airport Runs, and Corporate
              Outings
            </li>
          ...
          <p>
            Every vehicle in our fleet meets strict executive private hire
            standards:
          </p>
          ...
          <p>
            ...
            <br />
            Whether you&apos;re travelling alone, with family, or as part of a
            group, we’ll recommend the best vehicle to ensure comfort and
