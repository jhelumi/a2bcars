        ...
        <div className="flex flex-col items-center gap-6 text-center  text-brand-gray sm:items-start sm:text-left">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              Email: &nbsp;&nbsp;{' '}
              <a href="mailto:info@a2bcars.net">info@a2bcars.net</a>
            </div>
            <div className="flex items-center space-x-2">
              ...
              Whatsapp:&nbsp;&nbsp;{' '}
              <a href="https://wa.me/447435964303">Call me</a>
            </div>
            <div className="flex items-center space-x-2">
              <Hourglass className="h-4 w-4" />
              <span>
                Business Hours: &nbsp;&nbsp; 24/7 (pre-booked journeys only)
              </span>
            </div>
          </div>
          ...
          <ul className="list-disc  list-inside ml-4 text-left">
            ...
            <li>
              Any special requirements (child seat, extra luggage,
              meet-and-greet, etc.)
            </li>
          </ul>
          ...
          <p>
            If your business needs regular travel or you’d like to set up a
            corporate account, please let us know.
            <br />
            We’ll get back to you with options suited to your company.
          </p>
          ...
          <p>
            A2B Cars operates as a fully licensed executive private hire
            service:
          </p>
          <ul className="list-disc  list-inside ml-4 text-left">
